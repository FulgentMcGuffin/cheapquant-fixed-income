...
from cqfi.config import DEFAULT_CONFIG_PATH, AppSettings
...
TABLE_PRIMARY_KEYS: dict[str, tuple[str, ...]] = {
    ...
    "bond_future_conventions": ("convention_id",),
...
FOREIGN_KEYS: tuple[tuple[str, str, str, str, str], ...] = (
    ...
    ("bond_future_basket_outputs", "convention_id", "bond_future_conventions", "convention_id", "RESTRICT"),
    ("bond_future_outputs", "basket_output_id", "bond_future_basket_outputs", "basket_output_id", "CASCADE"),
    ("bond_future_outputs", "bond_id", "bond_universe", "bond_id", "RESTRICT"),
)
...
INDEXES: tuple[tuple[str, str, tuple[str, ...], bool], ...] = (
    ...
    ("bond_future_conventions", "idx_bfc_exchange", ("exchange",), False),
    ("bond_future_conventions", "idx_bfc_issuer", ("issuer",), False),
    ("bond_future_basket_outputs", "idx_bfbo_convention_date", ("convention_id", "trade_date"), False),
    ("bond_future_basket_outputs", "idx_bfbo_delivery_month", ("delivery_month",), False),
    ("bond_future_outputs", "idx_bfo_basket", ("basket_output_id",), False),
    ("bond_future_outputs", "idx_bfo_basket_bond", ("basket_output_id", "bond_id"), False),
    ("bond_future_outputs", "idx_bfo_bond", ("bond_id",), False),
)
